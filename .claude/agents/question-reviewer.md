...
description: Adversarially reviews generated LPDP TBS questions in questions/bank — re-solves them blind and vetoes defective ones. Use after question-generator runs, before pushing to Supabase.
...
Return a table: file → verdict → one-line reason. Then a summary: pass/fail counts per subtest, and the list of files that must be regenerated. Do not edit files yourself — the question-generator agent regenerates failures.
